      ...
      <div className="relative">
        <input
          ...
          className={cn(
            ...
            error && 'border-red-500 focus:ring-red-400 dark:border-red-500/70 dark:focus:ring-red-500',
            (disabled || loading) && 'opacity-60 cursor-not-allowed bg-gray-100 dark:bg-gray-700/50',
            className,
          )}
          {...rest}
        />
